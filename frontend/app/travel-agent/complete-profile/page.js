...
import { MapPin, Briefcase, Car, Plus, Trash2, Loader2, ChevronRight, CheckCircle2, FileText, DollarSign } from "lucide-react"
...
import { travelAgentService, uploadService, transportOriginsService, destinationsService } from "@/app/services/api"
...
export default function TravelAgentCompleteProfile() {
  ...
  const getOriginName = (originId) => {
    const origin = origins.find(o => o.id === parseInt(originId))
  ...
  const handleSubmit = async (e) => {
    ...
    const validRoutes = routes.filter(route => 
      route.origin_id && route.destination_id && route.cost && parseFloat(route.cost) > 0
    )
    ...
    for (const route of validRoutes) {
      if (!getOriginName(route.origin_id)) {
        toast.error("Please select valid origins for all routes")
        return
      }
    ...
    try {
      ...
      const profileData = {
        ...
        document_url: uploadedDocUrls.length === 1 ? uploadedDocUrls[0] : JSON.stringify(uploadedDocUrls),
        routes: validRoutes.map(route => ({
          origin_id: parseInt(route.origin_id),
          destination_id: parseInt(route.destination_id),
          transportation_type: route.transportation_type,
          cost: parseFloat(route.cost),
          description: route.description.trim() || `Transport from ${getOriginName(route.origin_id)} to ${getDestinationName(route.destination_id)} by ${route.transportation_type}`
        }))
      }

      // Validate profile data before sending
      if (!profileData.name || !profileData.contact_email || !profileData.contact_phone) {
      ...
      <div className="min-h-screen bg-gradient-to-br from-amber-50 to-orange-50">
        <div className="container max-w-5xl mx-auto px-4 py-8">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-3xl font-bold text-gray-900 mb-2">Complete Your Travel Agency Profile</h1>
            <p className="text-gray-600 max-w-2xl mx-auto">
              Welcome to Smart Tour Tanzania! Please provide your agency details and transport routes to complete your registration. 
              Your agency will be reviewed by our administrators before activation.
            </p>
          </div>
          ...
          <Alert className="mb-6 border-amber-200 bg-amber-50">
            ...
            <AlertDescription className="text-amber-700">
              After completing your agency profile, it will be submitted for review. Your transport routes will be available 
                ...
                <div className="space-y-2">
                  ...
                  <div className="bg-blue-50 border border-blue-200 rounded-lg p-3">
                    <p className="text-sm text-blue-800">
                      <strong>Required:</strong> Please upload your business license, registration certificates, 
                      or other relevant business documents (PDF or image format). Maximum 3 files.
                    </p>
                  </div>
                </div>
              </CardContent>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                        <div className="space-y-2">
                          ...
                          <Select
                            ...
                            onValueChange={(value) => handleRouteChange(index, 'origin_id', value)}
                          >
                        ...
                        <div className="space-y-2">
                          ...
                          <Select
                            ...
                            onValueChange={(value) => handleRouteChange(index, 'destination_id', value)}
                          >
                            <SelectTrigger className="border-gray-300">
                        ...
                        <div className="space-y-2">
                          ...
                          <Select
                            ...
                            onValueChange={(value) => handleRouteChange(index, 'transportation_type', value)}
                          >
                            <SelectTrigger className="border-gray-300">
                              <SelectValue />
                            </SelectTrigger>
                        ...
                        <div className="space-y-2">
                          <label className="text-sm font-medium text-gray-700">Cost (TZS) *</label>
