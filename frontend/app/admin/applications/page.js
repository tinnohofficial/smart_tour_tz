        ...
        <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto mx-2 sm:mx-auto">
          <DialogHeader>
            ...
            <DialogDescription className="text-sm">
              Review all information provided by the applicant before making a
              decision.
            </DialogDescription>
          </DialogHeader>
          ...
          {selectedApplication && (
            <div className="py-4">
              <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-6 gap-4">
                ...
                <div>
                  <RoleBadge role={selectedApplication.role} />
                </div>
              </div>

              <div className="space-y-6">
                {/* Tour Guide Details */}
                {selectedApplication.role === "tour_guide" &&
                    ...
                    <>
                      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                        <div>
                          ...
                          <p className="break-words">
                            {selectedApplication.details.full_name}
                          </p>
                        </div>
                        <div>
                          <h4 className="text-sm font-medium text-gray-500 mb-1">
                        ...
                        <div>
                          ...
                          <p className="break-words">
                            {selectedApplication.details.location}
                          </p>
                        </div>
                      </div>
                      <div>
                      ...
                      <div>
                        ...
                        <div className="mt-2">
                          <a
                            href={
                              selectedApplication.details.license_document_url
                            }
                            target="_blank"
                ...
                {selectedApplication.role === "hotel_manager" &&
                  selectedApplication.details && (
                    <>
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                          ...
                          <p>{selectedApplication.details.name}</p>
                        </div>
                        <div>
                          <h4 className="text-sm font-medium text-gray-500 mb-1">
                            Phone Number
                        ...
                        <div>
                          ...
                          <p>{selectedApplication.details.location}</p>
                        </div>
                        <div>
                          <h4 className="text-sm font-medium text-gray-500 mb-1">
                            Capacity
                          </h4>
                          <p>{selectedApplication.details.capacity} rooms</p>
                        </div>
                        <div>
                          <h4 className="text-sm font-medium text-gray-500 mb-1">
                          ...
                          <p>
                            TZS{" "}
                            {selectedApplication.details.base_price_per_night}{" "}
                            /=
                          </p>
                        </div>
                      </div>
                      ...
                      <div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-2">
                          {selectedApplication.details.images &&
                            selectedApplication.details.images.map(
                              (
                                image,
                                index, // Removed types
                              ) => (
                ...
                {selectedApplication.role === "travel_agent" &&
                  selectedApplication.details && (
                    <>
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                        ...
                        <div>
                          ...
                          <p>{selectedApplication.details.contact_email}</p>
                        </div>
                        <div>
                          <h4 className="text-sm font-medium text-gray-500 mb-1">
                            Contact Phone
                          </h4>
                          <p>{selectedApplication.details.contact_phone}</p>
                        </div>
                      </div>
                      {selectedApplication.details.routes &&
                        selectedApplication.details.routes.length > 0 && (
                          <div>
                            <h4 className="text-sm font-medium text-gray-500 mb-1">
                              Transport Routes
                            </h4>
                            <div className="mt-2 space-y-4">
                              {selectedApplication.details.routes.map(
                                (route, index) => (
                                  <div
                                    key={`route-${index}`}
                        ...
                        <div>
                          ...
                          <div className="mt-2">
                            {Array.isArray(
                              ...
                              selectedApplication.details.document_url.map(
                                (doc, index) => (
                                  <a
                                    key={`doc-${index}`}
                                    href={doc}
                              ...
                              <a
                                href={selectedApplication.details.document_url}
                                target="_blank"
                                rel="noopener noreferrer"
                                className="flex items-center gap-2 text-primary hover:underline"
                              >
          ...
          <DialogFooter className="flex justify-between">
            <div className="flex gap-2">
              <Button
                ...
                onClick={() =>
                  selectedApplication &&
                  rejectApplication(selectedApplication.user_id)
                }
                disabled={isProcessing}
              >
            ...
            <Button
              ...
              onClick={() =>
                selectedApplication &&
                approveApplication(selectedApplication.user_id)
              }
              disabled={isProcessing}
            >
