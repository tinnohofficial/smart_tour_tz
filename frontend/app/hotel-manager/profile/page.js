...
import { useHotelManagerStore } from "./hotelManagerStore"
          ...
          <form onSubmit={onSubmit} className="space-y-6">
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                <label htmlFor="hotelName" className="text-sm font-medium leading-none">Hotel Name</label>
                <Input
                  id="hotelName"
              ...
              <div className="space-y-2">
                <label htmlFor="hotelLocation" className="text-sm font-medium leading-none">Hotel Location</label>
                <Input
                  id="hotelLocation"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  <label htmlFor="hotelCapacity" className="text-sm font-medium leading-none">Hotel Capacity</label>
                  <Input
                    id="hotelCapacity"
                ...
                <div className="space-y-2">
                  <label htmlFor="accommodationCosts" className="text-sm font-medium leading-none">Accommodation Costs</label>
                  <Input
              ...
              <div className="space-y-2">
                <label htmlFor="hotelFacilities" className="text-sm font-medium leading-none">Hotel Facilities</label>
                <Textarea
                  id="hotelFacilities"
              ...
              <div className="space-y-2">
                <label htmlFor="hotelImages" className="text-sm font-medium leading-none">Hotel Images</label>
                <FileUploader
