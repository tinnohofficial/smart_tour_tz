      ...
      <div className="bg-amber-700 p-4 sm:p-6 mb-4 sm:mb-6 rounded-lg">
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4">
          <div className="w-full lg:w-auto">
            ...
            <p className="text-amber-100 text-sm sm:text-base">Welcome back, {userData?.name || 'Tour Guide'}</p>
      ...
      {profileStatus === 'active' ? (
        ...
        <div className="text-center py-12">
          ...
          <h2 className="text-2xl font-semibold text-gray-700 mb-4">
            {profileStatus === 'pending_profile' ? 'Complete Your Profile' : 
             profileStatus === 'pending_approval' ? 'Profile Under Review' : 
             'Getting Started'}
          </h2>
          ...
          {profileStatus === 'pending_profile' && (
            <Button asChild className="bg-amber-600 hover:bg-amber-700">
              <Link href="/tour-guide/complete-profile">Complete Profile Now</Link>
            </Button>
          )}
        </div>
      )}
