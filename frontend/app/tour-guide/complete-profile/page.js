...
export default function TourGuideCompleteProfile() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setIsUploading(true)
      const { url: licenseUrl } = await uploadService.uploadDocument(licenseFile)
        ...
        <div className="container max-w-4xl mx-auto px-4 py-8">
          ...
          <Alert className="mb-6 border-amber-200 bg-amber-50">
            ...
            <AlertDescription className="text-amber-700">
              After completing your profile, it will be submitted for review. You'll receive access to full tour guide 
              features once approved by our administrators. This typically takes 1-2 business days.
            </AlertDescription>
          </Alert>
          ...
          <Card className="shadow-lg">
            <CardHeader>
              ...
              <CardDescription>
                Please provide accurate information as this will be used for verification purposes
              </CardDescription>
            </CardHeader>
              ...
              <CardContent className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-gray-500">
                    Include details about your experience, certifications, specialties, and languages you speak
                  </p>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="bg-blue-50 border border-blue-200 rounded-lg p-3">
                    <p className="text-sm text-blue-800">
                      <strong>Required:</strong> Please upload a clear copy of your tour guide license, 
                      certification, or relevant qualification document (PDF or image format).
                    </p>
                  </div>
                </div>
              </CardContent>
