...
export const API_ENDPOINTS = {
  ...
  ACTIVITIES_BY_DESTINATION: (destinationId) => `/activities?destinationId=${destinationId}`,
...
export const VALIDATION_MESSAGES = {
  REQUIRED_FIELDS: 'Required fields missing: name, location, description, capacity, and base_price_per_night are required',
